...
public class ORDSApiTestWithPath extends HRTestBase {
    ...
    public  void test1(){
        ...
        String secondtCountryName=response.path("items[1].country_name");
        System.out.println("secondtCountryName = " + secondtCountryName);

        // print  "http://54.210.68.41:1000/ords/hr/countries/CA"
